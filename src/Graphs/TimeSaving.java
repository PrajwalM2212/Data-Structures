...
public class TimeSaving {
    ...
    private void timeTaken(int rowIndex, long timeSoFar, int from) {
            ...
            for (int i = 0; i < matrix.length; i++) {
                if (matrix[rowIndex][i] != 0 && i != from) {
                    if (alreadyTravelled[rowIndex][i] == 1) {
                        ...
                        timeTaken(i, travelTime + timeSoFar, rowIndex);
                        ...
                        timeTaken(i, matrix[rowIndex][i] + timeSoFar, rowIndex);
                    }
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        timeSaving.matrix = matrix;
        timeSaving.timeTaken(0, 0, -1);
